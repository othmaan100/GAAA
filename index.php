      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            ...
            <li><a href="test.php">Start Exam</a></li>
        ...
        <span class="glyphicon glyphicon-user"></span>&nbsp;Hi' <?php echo $row['email']; ?>&nbsp;<span class="caret"></span></a>
            ...
            <div class="item active">
                     <div class="containerx">
                            ...
                            <div class="caption caption-home home-carousel pull-right">

                                      <!-- value: 0--><h1 color="black">Need The Right Staff, Right Now?</h1>
                                  <p>&nbsp;</p>
                                  <p color="black">Our talent sourcing solutions complement your internal HR and 
                                  recruitment teams, reducing your reliance on recruitment agencies and 
                                  keeping your costs down.</p>
                            ...
                            <img alt="wr slider" class="attachment-slider wp-post-image" src="images/bglight2.jpg" height="520px;"> 
                             ...
                             <div id="blue-band-holder">
                                <!-- value: 0--><p>Computer Scinece Examination Software</p>
                                           </div>
