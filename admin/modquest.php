...
*/if (isset($_SESSION['qid'])){
    $id= $_SESSION['qid'];
    $qr = $db_con->prepare("SELECT * FROM questions where quesNo='$id'");
    $qr->execute();
      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="quest_list.php"> Questions List</a></li>
        ...
        <span class="glyphicon glyphicon-user"></span>&nbsp;Hi' <?php echo $row['username']; ?>&nbsp;<span class="caret"></span></a>
            ...
            <div class="item active">
					...
					if(isset($_GET['msg'])){
					 ...
					 ?>
                                             ...
                                             <div style=" min-height: 529px; margin-top: 20px;">
                                                 <form name="mod_quest" method="post" action="modquest_exe.php" enctype="application/x-www-form-urlencoded">
				...
				<tr>
						...
						<td>
                                                    <input type="number" class="  col-md-3" size="5" id="quesNo" name="quesNo"   value="<?php $qno=$qrow['quesNo']; echo $qno;?>"  maxlength="30" />
						</td>
				</tr>
				<tr>
                                    <td> <label class=" control-label" for="ques">Question:</label> </td>
						<td>
                                                    <input type="text" class=" form-control" name="ques" value="<?php echo $qrow['ques'];;?>" id="ques"  />
                                                    <input type="hidden"  name="quesId" value="<?php echo $qrow['q_id'];;?>" id="quesId"  />
						</td>
				</tr>
                                  <?php 						
                            $sqla= "SELECT * FROM answers where quesNo='$qno'";	
                                $i=0;
				...
				<tr>
                                    <td> <label class=" control-label" for="op1"> Choice <?php echo $i;?>:</label></td>
                                    <td><input type="text"  class="form-control" name="ans[]" value="<?php  echo $rowsa['ans']; ?>" id="opts"  /></td>
                                    <td><input type="hidden" value="<?php echo $rowsa['ans_id']; ?>" name="ansid[]"></td>
                                </tr>
				<?php 
				...
				<tr>
					<td colspan=2 align="center"><button name="update" class="btn btn-default">Update Question</button> </td>
